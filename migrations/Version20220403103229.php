 ...
 */
final class Version20220403103229 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD blog_picture VARCHAR(255) DEFAULT NULL, ADD user_avatar VARCHAR(255) DEFAULT NULL');
    }
